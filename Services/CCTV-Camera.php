...
<head>
	...
	<title> CCTV Camera - Tectignis IT Solutions Graphic CCTV Camera in India</title>
...
<?php include("include/header1.php"); ?>
	...
	<?php 
	$sql=mysqli_query($conn,"select * from servicelist where name='CCTV_camera'");
($arr=mysqli_fetch_array($sql))  ?>
	<section class="breadcrumb-area" style="background-image: url('../assets/img/backgrounds/cctv.webp');">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
