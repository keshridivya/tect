...
<head>
	...
	<title> Digital Marketing - Tectignis IT Solutions Digital Marketing Company in India</title>
...
<?php include("include/header1.php"); ?>
	...
	<?php 
	$sql=mysqli_query($conn,"select * from servicelist where name='Digital_Marketing'");
($arr=mysqli_fetch_array($sql))  ?>
	<section class="breadcrumb-area" style="background-image: url('../assets/img/backgrounds/digital-marketing.webp');">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
