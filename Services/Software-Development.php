...
<head>
	...
	<title> Software Development - Tectignis IT Solutions Software Development Company in India</title>
...
<?php include("include/header1.php"); ?>
	...
	<?php 
	$sql=mysqli_query($conn,"select * from servicelist where name='Software_Development'");
($arr=mysqli_fetch_array($sql))  ?>
	<section class="breadcrumb-area" style="background-image: url('../assets/img/backgrounds/software.webp');">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
